<template>
  <nav class="w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white px-4 py-2 text-xl ">
    ...
    <img v-if="isLogedIn" src="https://lh3.googleusercontent.com/a-/AOh14GhcLJji4yFxnnQX_yCDuIuR1XQ8S6vFpqd-d7xn=s96-c" width="50px" height="50px" class=""/>
    <span class="mx-2">{{ authUser.displayName }}</span>
