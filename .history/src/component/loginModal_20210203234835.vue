                        ...
                        <div class="panel panel-login">
                            <div class="w-full flex">
                                <div class="grid grid-cols-2 gap-4 justify-center">
                                    <div class="">
                                        <a @click="isLoginShow=true" href="javascript:;" class="text-center text-lg">Login</a>
                                    </div>
                                    <div class="">
                                        <a @click="isLoginShow=false" href="javascript:;" class="text-center text-lg">Register</a>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div v-if="!isLoginShow">
                                            ...
                                            <form class="m-2" @submit.prevent="SignupSubmit">
                                                <div >
                                                    ...
                                                    <input class="rounded border p-2 w-full" v-model="name" type="text" placeholder="Enter Name"/>
                                                </div>
                                                <div >
                                                    <label>Email<span class="text-red-600">*</span></label>
                                                    <input class="rounded border p-2 w-full" v-model="email" type="text" placeholder="Enter Email"/>
                                                </div>
                                                <div >
                                                    <label>Password<span class="text-red-600">*</span></label>
                                                    <input class="rounded border p-2 w-full" v-model="password" type="password" placeholder="Enter Password"/>
