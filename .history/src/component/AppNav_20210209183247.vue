...
<div>
  <nav class="w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white px-4 py-4 text-xl ">
    ...
    <div v-if="storestorestorestorestorestorestorestorestorestorestorestorestorestorestorestorestoreisLogedIn" class="dropdown inline-block relative float-right text-left -my-2">
