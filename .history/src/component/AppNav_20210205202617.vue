...
<div>
  <nav class="w-full bg-gradient-to-r from-blue-600 to-blue-500 text-white px-4 py-4 text-xl ">
    ...
    <button v-if="!isLogedIn" @click="$emit('open-login-modal')" class="bg-gray-300 text-gray-700 font-semibold rounded inline-flex items-center float-right mx-2">Log In</button>
